...
= 1.2.0 =
* Added option to use custom images/icons for sharing bar & added shortcodes for share bar

= 1.1.4 =
* Added Twitter Login Pop up design

= 1.1.3 =
* Added New Mobile Friendly Share Bar Design
...
= 1.1.1 =
* We have made easier to configure Social login & sharing

= 1.1.0 =
* This version included more sharing button style options and more functions on Social login settings